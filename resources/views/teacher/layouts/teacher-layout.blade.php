                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li>
                                    <a href="{{route('student.exercise')}}" class="dropdown-item">Mahasiswa</a>
                                </li>
                                <li>
                                    <a href="{{route('student.exercise')}}" class="dropdown-item">Kelas</a>
                                </li>
                                <li>
                                    <a href="{{route('student.exercise')}}" class="dropdown-item">Tahun Ajaran</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false" class="nav-link dropdown-toggle">Hasil</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <li><a href="{{route('teacher.exercises.result')}}" class="dropdown-item">Latihan</a></li>
                                <li><a href="#" class="dropdown-item">Tugas</a></li>
                                <li><a href="#" class="dropdown-item">Ujian</a></li>
                            </ul>
                        </li>
