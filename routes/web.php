...
Route::group(['prefix' => 'a', 'middleware' => ['admin', 'auth', 'pvb']], function () {
    ...
    Route::get('list-student', [AdminController::class, 'getStudent'])->name('admin.get.student');
    
    Route::get('teacher', [AdminController::class, 'teacher'])->name('admin.teacher');
    Route::get('list-teacher', [AdminController::class, 'getTeacher'])->name('admin.get.teacher');
});
...
Route::group(['prefix' => 's', 'middleware' => ['teacher', 'auth', 'pvb']], function () {
    ...
    Route::get('exercises-result-detail/{id}', [TeacherController::class, 'exercisesResultDetail'])->name('teacher.exercises.result.detail');
    Route::get('exercises-result-student', [TeacherController::class, 'exercisesResultStudent'])->name('teacher.exercises.result.student');
